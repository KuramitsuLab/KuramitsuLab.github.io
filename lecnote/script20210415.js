...
problems = [
    ...
    ["ゴルフ大好き", "https://atcoder.jp/contests/arc046/tasks/arc046_a", "全探索"],
    ...
    if (atcoder_id.value !== '') {
        ...
        fetch(url).then(function (response) {
            response.text().then(function (text) {
                ...
                element.innerHTML = `<span class="label-ac">正解問題数</span> ${AC} <span class="label-wa">時間(長めに計算されます)</span> ${time}`
            });
        });
    }
}
